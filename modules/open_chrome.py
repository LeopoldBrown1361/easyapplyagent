...
try:
    ...
    if stealth_mode:
        ...
        cookies_arg = 'user-data-dir=C:\\Users\\leo\\OneDrive - University of Arizona\\Documents\\PersonalCodingProjects\\jobApplierBot\\browser cookies'
        options.add_argument(cookies_arg)
