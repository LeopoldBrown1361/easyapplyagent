...
# Your legal name
first_name = "Leopold"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Ivan"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Brown"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "9282255257"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Tucson"                  # Los Angeles, San Francisco, etc.
'''
