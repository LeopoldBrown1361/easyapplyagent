...
search_terms = ["IT tech support", "Software Developer", "Python Developer", "Selenium Developer", "React Developer", "Java Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
...
job_type = ["Full-time", "Part-time", "Contract", "Temporary", "Internship", "Other"]                      # (multiple select) "Full-time", "Part-time", "Contract", "Temporary", "Volunteer", "Internship", "Other"
on_site = ["On-site", "Remote", "Hybrid"]                       # (multiple select) "On-site", "Remote", "Hybrid"

# if there are any states in teh unacceptable_states list, the bot will use this list to filter out jobs in those states. In this case it will not use the acceptable_states list. If the unacceptable_states list is empty, the bot will use the acceptable_states list to filter and only apply to jobs in those states.
acceptable_states = [ ]
unacceptable_states = ['FL']
